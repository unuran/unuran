...
int
_unur_acg_JAVA_tdr_ps( struct unur_gen *gen, FILE *out, const char *rand_name, const char *pdf_name )
     /*----------------------------------------------------------------------*/
     /* code generator for method TDR variant PS (proportional squeeze)      */
     /*                                                                      */
     /* parameters:                                                          */
...
int
_unur_acg_JAVA_tdr_class_IV( struct unur_gen *gen, FILE *out, const char *rand_name, const char *pdf_name )
     /*----------------------------------------------------------------------*/
...
int
_unur_acg_JAVA_begin_class( struct unur_gen *gen, FILE *out, const char *rand_name, const char *pdf_name )
     /*----------------------------------------------------------------------*/
...
int
_unur_acg_JAVA_end_class( struct unur_gen *gen, FILE *out, const char *rand_name, const char *pdf_name )
     /*----------------------------------------------------------------------*/
