...
\put(3137,1913){\rjust{$\sigma=2, \theta=0$}}
\put(3137,2013){\rjust{$\sigma=1, \theta=0$}}
\put(2000,2276){\cjust{Exponential Distribution}}
...
\put(3550,300){\cjust{3}}
\put(2517,300){\cjust{2}}
\put(1483,300){\cjust{1}}
\put(450,300){\cjust{0}}
