...
\put(3137,1813){\rjust{$\alpha=3, \gamma=0$}}
\put(3137,1913){\rjust{$\alpha=2, \gamma=0$}}
\put(3137,2013){\rjust{$\alpha=1, \gamma=0$}}
\put(2000,2276){\cjust{Gamma Distribution}}
...
\put(2930,300){\cjust{4}}
\put(2310,300){\cjust{3}}
\put(1690,300){\cjust{2}}
\put(1070,300){\cjust{1}}
\put(450,300){\cjust{0}}
\put(400,2126){\rjust{1}}
\put(400,1263){\rjust{0.5}}
\put(400,400){\rjust{0}}
\endGNUPLOTpicture
