...
\put(3137,1913){\rjust{$\phi=2, \theta=0$}}
\put(3137,2013){\rjust{$\phi=1, \theta=0$}}
\put(2000,2276){\cjust{Laplace Distribution (Two-sided Exponential)}}
...
\put(760,300){\cjust{-4}}
\put(450,300){\cjust{-5}}
\put(400,1969){\rjust{0.5}}
\put(400,1655){\rjust{0.4}}
\put(400,1341){\rjust{0.3}}
\put(400,1028){\rjust{0.2}}
\put(400,714){\rjust{0.1}}
\put(400,400){\rjust{0}}
\endGNUPLOTpicture
