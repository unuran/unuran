...
%%CreationDate: Tue Jul 27 17:07:05 1999
%%DocumentFonts: 
...
\put(3137,1913){\rjust{$\sigma=2, \mu=0$}}
\put(3137,2013){\rjust{$\sigma=1, \mu=0$}}
\put(2000,2276){\cjust{Gaussian Distribution}}
...
\put(760,300){\cjust{-4}}
\put(450,300){\cjust{-5}}
\put(400,2126){\rjust{0.5}}
\put(400,1781){\rjust{0.4}}
\put(400,1436){\rjust{0.3}}
\put(400,1090){\rjust{0.2}}
\put(400,745){\rjust{0.1}}
\put(400,400){\rjust{0}}
\endGNUPLOTpicture
