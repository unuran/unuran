...
\put(3137,1913){\rjust{$a=3$}}
\put(3137,2013){\rjust{$a=1$}}
\put(2000,2276){\cjust{Pareto Distribution}}
...
\put(450,300){\cjust{0}}
\put(400,2126){\rjust{2}}
\put(400,1695){\rjust{1.5}}
\put(400,1263){\rjust{1}}
\put(400,832){\rjust{0.5}}
\put(400,400){\rjust{0}}
\endGNUPLOTpicture
