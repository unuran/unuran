 ...
 *****************************************************************************
 *                                                                           *
 *   FILE:      c_logistic_gen.c                                             *
 *                                                                           *
 *   Special generators for Logistic distribution                            *
 *                                                                           *
 *****************************************************************************
     $Id$
 *****************************************************************************
...
int 
_unur_stdgen_logistic_init( struct unur_par *par, struct unur_gen *gen )
     /*----------------------------------------------------------------------*/
     /* initialize special generator for Logistic distribution                */
     ...
     /*----------------------------------------------------------------------*/
{
  ...
  case UNUR_STDGEN_INVERSION:   /* inversion method */
    ...
    _unur_cstd_set_sampling_routine(par,gen,unur_stdgen_sample_logistic_inv); 
    return 1;
...
} /* end of _unur_stdgen_logistic_init() */
...
} /* end of unur_stdgen_sample_logistic_inv() */
