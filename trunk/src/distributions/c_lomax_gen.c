 ...
 *   FILE:      c_lomax_gen.c                                                *
 *                                                                           *
 *   Special generators for Lomax distribution                               *
 *                                                                           *
 *****************************************************************************
     $Id$
 *****************************************************************************
...
int 
_unur_stdgen_lomax_init( struct unur_par *par, struct unur_gen *gen )
     /*----------------------------------------------------------------------*/
     /* initialize special generator for Lomax distribution                */
     ...
     /*----------------------------------------------------------------------*/
{
  ...
  case UNUR_STDGEN_INVERSION:   /* inversion method */
    ...
    _unur_cstd_set_sampling_routine(par,gen,_unur_stdgen_sample_lomax_inv); 
    return UNUR_SUCCESS;
...
} /* end of _unur_stdgen_lomax_init() */
...
double _unur_stdgen_sample_lomax_inv( struct unur_gen *gen )
     /* Inversion method */
{
  /* -X- generator code -X- */
  double U,X;
...
} /* end of _unur_stdgen_sample_lomax_inv() */
