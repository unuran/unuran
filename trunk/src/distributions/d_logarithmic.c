...
/* function prototypes                                                       */
static double _unur_pmf_logarithmic(int k, double *params, int n_params);
/*  static double _unur_cdf_logarithmic(int k, double *params, int n_params);       */

/*---------------------------------------------------------------------------*/

double
_unur_pmf_logarithmic(int k, double *params, int n_params)
{ 
