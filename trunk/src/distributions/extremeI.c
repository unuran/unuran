 ...
 *****************************************************************************
 *                                                                           *
 *  Extreme value distribution  [3; ch.22, p.2]                              *
...
/* function prototypes                                                       */
static double _unur_pdf_extremeI(double x, double *params, int n_params);
static double _unur_dpdf_extremeI(double x, double *params, int n_params);
static double _unur_cdf_extremeI(double x, double *params, int n_params);

/*---------------------------------------------------------------------------*/

double
_unur_pdf_extremeI( double x, double *params, int n_params )
{ 
  switch (n_params) {
  case 2:  /* non standard */
    /* standardize */
...
double
_unur_dpdf_extremeI( double x, double *params, int n_params )
{ 
...
double
_unur_cdf_extremeI( double x, double *params, int n_params )
{ 
  switch (n_params) {
  case 2:  /* non standard */
    /* standardize */
