...
/* 
   Set size of guide table relative to length of probability vector.
   ...
   default is 1. If the relative size is set to 0, sequential search
   is used.
*/
...
/* Set variant for setup step. Possible values are 1 or 2.  Variant 2
   is faster but more sensitive to roundoff errors when the guide
   table is large. By default variant 2 is used for short probability
