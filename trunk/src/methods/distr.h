...
double unur_distr_cont_pdf( double x, UNUR_DISTR *distribution );
...
double unur_distr_cont_dpdf( double x, UNUR_DISTR *distribution );
...
double unur_distr_cont_cdf( double x, UNUR_DISTR *distribution );
