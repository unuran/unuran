...
int unur_ninv_use_table(UNUR_PAR *parameters, int no_of_points);
/* Generates a table with @code{no_of_points} points containing
   suitable starting values for the iteration. The value of
   @code{no_of_points} must be at least 10 or the value will
   be set automatically to 10.
   Depending on the uniform random number (used by
   NINV) an adequate starting value is choosen from the table.      
*/   
/*
   The table itself is generated by applying NINV to
   equidistant points (no_of_points in number) between 0 and 1.
 */
