...
UNUR_GEN *_unur_stdr_init( UNUR_PAR *parameters );
/* initialize new generator                                                  */

double _unur_stdr_sample( UNUR_GEN *generator );
double _unur_stdr_sample_check( UNUR_GEN *generator );
/* sample from generator                                                     */

void _unur_stdr_free( UNUR_GEN *generator);
