...
/* 
   ...
   =HOWTOUSE
      ...
      UNURAN provides a unified API to all sources of random numbers.
...
int unur_urng_set_sample_array( UNUR_URNG *urng, unsigned int (*samplearray)(void *state, double *X, unsigned int dim) );
/*
   Set function to fill array @var{X} of length @var{dim} with random
   numbers generated by generator @var{urng} (if available).
*/

int unur_urng_set_sync( UNUR_URNG *urng, void (*reset)(void *sync) );
/* 
